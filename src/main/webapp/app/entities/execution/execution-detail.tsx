      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            <dt>
              <span id="planned">Planned</span>
            </dt>
            <dd>
              <TextFormat value={executionEntity.planned} type="date" format={APP_LOCAL_DATE_FORMAT} />
            </dd>
            <dt>
              <span id="done">Done</span>
            </dt>
            <dd>
              <TextFormat value={executionEntity.done} type="date" format={APP_LOCAL_DATE_FORMAT} />
            </dd>
            <dt>
              <span id="doneComment">Done Comment</span>
            </dt>
            <dd>{executionEntity.doneComment}</dd>
            <dt>Diagnostic</dt>
            <dd>{executionEntity.diagnostic ? executionEntity.diagnostic.id : ''}</dd>
            <dt>Person</dt>
            <dd>{executionEntity.person ? executionEntity.person.id : ''}</dd>
          </dl>
